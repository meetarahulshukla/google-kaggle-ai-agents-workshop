...
Basic agent workflows and orchestration patterns.

### Tool Calling Agent

Agent capable of invoking external tools and APIs.
...
Agent that gathers, analyzes, and summarizes information.

### Multi-Agent System

Collaborative agents working together to solve complex tasks.
